...
embed_ais,count_embed_ais=pro_draw(coef_ais)
...
width=0.4
_w=width/2
plt.bar(ori,count_ori,width,color="green",label='88')
#plt.bar([i+0.2 for i in xindex],ycount,width,color="blue",label='88')
